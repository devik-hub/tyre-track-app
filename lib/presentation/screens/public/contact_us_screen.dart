                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          trailing: const Icon(Icons.call, size: 16, color: AppColors.mrfRed),
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(children: [
                      ...
                      ElevatedButton(
                        onPressed: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Thank you! Message sent.'))),
