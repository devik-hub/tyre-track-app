          ...
          Consumer(builder: (ctx, r, _){
            ...
            return total.maybeWhen(
              data: (amt) => amt == 0 ? const SizedBox.shrink() : Container(
                ...
                child: Text('COD ₹${amt.toStringAsFixed(0)}',
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('No ${activeFilter == 'all' ? '' : activeFilter.replaceAll('_', ' ')} orders',
      ...
      child: Row(
        children: _filters.map((f) {
          ...
          return Padding(
            ...
            child: FilterChip(
              label: Text(f.label,
                style: TextStyle(fontSize: 11, fontWeight: isSelected ? FontWeight.bold : FontWeight.normal, color: isSelected ? color : Colors.grey.shade400),
              ),
              selected: isSelected,
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text('₹${order.finalAmountRupees.toStringAsFixed(0)}',
                      style: const TextStyle(color: AppColors.mrfRed, fontWeight: FontWeight.bold, fontSize: 18),
                    ),
