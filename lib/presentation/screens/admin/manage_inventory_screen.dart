                    ...
                    child: p.imageUrls.isNotEmpty
                        ? ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              ...
                              errorWidget: (c, u, e) => Icon(p.category == 'casing' ? Icons.circle : Icons.tire_repair, color: isLowStock ? AppColors.mrfRed : Colors.white70, size: 30),
                            ),
                          )
                        : Icon(p.category == 'casing' ? Icons.circle : Icons.tire_repair, color: isLowStock ? AppColors.mrfRed : Colors.white70, size: 30),
                  ),
