...
// ═══════════════════════════════════════════════════════════════════════════
// BUG #1 FIX — All admin order providers use .snapshots() only
// ═══════════════════════════════════════════════════════════════════════════
...
/// Admin: Single order detail — real-time
...
// ─── Keep existing names as aliases for backward compat ───────────────────
final allOrdersProvider = allOrdersStreamProvider;

/// Customer: My orders — BUG #6 FIX — real-time
