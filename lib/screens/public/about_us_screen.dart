                  ...
                  Expanded(
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Text('Our Mission', style: TextStyle(fontSize: 20, color: Theme.of(context).primaryColor, fontWeight: FontWeight.bold)),
                  ...
                  Expanded(
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Text('Our Vision', style: TextStyle(fontSize: 20, color: Theme.of(context).primaryColor, fontWeight: FontWeight.bold)),
                            const SizedBox(height: 10),
                            const Text(
        ...
        child: Column(
          ...
          children: [
            Image.asset(imagePath, height: 200, fit: BoxFit.cover,
                errorBuilder: (context, error, stackTrace) => const SizedBox(height: 200, child: Center(child: Icon(Icons.image_not_supported, size: 50)))),
            Padding(
              padding: const EdgeInsets.all(16.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
